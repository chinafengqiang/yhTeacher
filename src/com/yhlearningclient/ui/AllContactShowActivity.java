...
public class AllContactShowActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		totalcount = contactManager.getAllCount(testPaperId);
...
//				}
		...
		edtSearch.setHint("共有" + totalcount + "个学员");
		edtSearch.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence s, int start, int before,
				...
				List<Student> list = contactManager.getContactByCondition(condition,testPaperId);
				if (list != null)
					bindView(list);
	...
	private void bindView(List<Student> list) {
	...
	public boolean onContextItemSelected(MenuItem item) {
		AdapterContextMenuInfo menuInfo = (AdapterContextMenuInfo) item
				.getMenuInfo();
		Student contact = contactManager.getContactById((int) menuInfo.id);
...
class AllListAdapeter extends BaseAdapter {
	...
	public AllListAdapeter(Context context, List<Student> list) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		final Student contact = (Student) getItem(position);
...
//		TextView txtPhone = (TextView) convertView.findViewById(R.id.childPhone);
