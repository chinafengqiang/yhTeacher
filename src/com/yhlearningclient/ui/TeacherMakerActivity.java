 ...
 */
public class TeacherMakerActivity extends ActivityGroup {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_teachingmaker);
	...
	public void changeTab2(View view) {
		Intent i = new Intent(this, ScheduleTableActivity.class);
	...
	public void changeTab3(View view) {
		Intent i = new Intent(this, CourseTableActivity.class);
		View v = getLocalActivityManager().startActivity(ScheduleTableActivity.class.getName(), i).getDecorView();
		tabcontent.removeAllViews();
		tabcontent.addView(v);
	}
