 ...
 */
public class MyCourseBookActivity extends Activity {
	/*
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/* 初始化mPath，用以显示目前路径 */
		rootPath = Environment.getExternalStorageDirectory().getPath() + "/myCourseBook";
...
//				AlertDialog.Builder builder = new AlertDialog.Builder(MyCourseBookActivity.this);
...
//					if (t.equals("video")) {
//						intentForward("/sdcard/myCourseBook/"+getMIMETypeName(file));
//					}
//				}
				...
				builder.setItems(is, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						case 1:
							...
							deleteFile(f);
							getFileDir(rootPath);
							Tool.ShowMessage(MyCourseBookActivity.this, is[which]);
					//		Tool.ShowMessage(MyVideoListActivity.this, is[which]);
							break;
						case 2:
							Tool.ShowMessage(MyCourseBookActivity.this, is[which]);
