 ...
 */
public class MyAdditionalFileActivity extends Activity {
	/*
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/* 初始化mPath，用以显示目前路径 */
		rootPath = Environment.getExternalStorageDirectory().getPath() + "/myAdditionalFile";
...
//				AlertDialog.Builder builder = new AlertDialog.Builder(MyAdditionalFileActivity.this);
...
//						switch (which) {
//						case 0:
//					//		Tool.ShowMessage(MyVideoListActivity.this, is[which]);
//							break;
//						case 1:
//					//		Tool.ShowMessage(MyVideoListActivity.this, is[which]);
//							break;
...
//					if (t.equals("video")) {
//						intentForward("/sdcard/myAdditionalFile/"+getMIMETypeName(file));
//					}
//				}
				...
				builder.setItems(is, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						case 1:
							...
							deleteFile(f);
							getFileDir(rootPath);
							Tool.ShowMessage(MyAdditionalFileActivity.this, is[which]);
					//		Tool.ShowMessage(MyVideoListActivity.this, is[which]);
							break;
						case 2:
							Tool.ShowMessage(MyAdditionalFileActivity.this, is[which]);
