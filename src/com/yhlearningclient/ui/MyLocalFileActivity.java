 ...
 */
public class MyLocalFileActivity extends Activity {
	/*
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/* 初始化mPath，用以显示目前路径 */
		rootPath = Environment.getExternalStorageDirectory().getPath() + "/myLocalFile";
...
//		common_back = (Button) this.findViewById(R.id.common_back);
		...
		list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(MyLocalFileActivity.this);
		...
		list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (file.isDirectory()) {
					...
					if (t.equals("video")) {
						intentForward("/sdcard/myLocalFile/"+getMIMETypeName(file));
					}
				}
			}
		});
