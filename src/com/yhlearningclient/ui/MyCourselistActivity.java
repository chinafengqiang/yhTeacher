...
public class MyCourselistActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/* 初始化mPath，用以显示目前路径 */
		rootPath = Environment.getExternalStorageDirectory().getPath() + "/myCoursePlan";
...
//				AlertDialog.Builder builder = new AlertDialog.Builder(MyCourselistActivity.this);
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						case 0:
							...
							if (file.isDirectory()) {
								...
								if (t.equals("video")) {
									intentForward("/sdcard/myCoursePlan/"+getMIMETypeName(file));
								}
							}
							break;
						case 1:
							...
							deleteFile(f);
							getFileDir(rootPath);
							Tool.ShowMessage(MyCourselistActivity.this, is[which]);
					//		Tool.ShowMessage(MyVideoListActivity.this, is[which]);
							break;
						case 2:
							Tool.ShowMessage(MyCourselistActivity.this, is[which]);
